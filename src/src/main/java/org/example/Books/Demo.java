...
public class Demo {
    public static void Main(String[] args) {
        ...
        System.out.println(Arrays.toString(bookService.filterBooksByAuthor(new Author(1, "John", "Jacob"), books)));
        System.out.println(Arrays.toString(bookService.filterBooksByPublisher(new Publisher(2, "RoadHouse"), books)));
